...
class ThemuseDataTransformer:
    ...
    def transform_job_listing(self, job):
        ...
        transformed_job = {
            ...
            FIELDS["language"]: HelperTransform.transform_detect_language(job_description)
        }
    ...
    def transform_jobs(self):
        ...
        for job in raw_jobs:
            ...
            if "Germany" in job_location or "Flexible / Remote" in job_location:
                job["contents"] = HelperTransform.transform_translate_unicode_characters(job.get("contents", ""))
